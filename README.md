...
run in SimScale, with transient follow-up. This is a hobbyist screening study
...
| Iterations | 1,000 (steady), transient follow-up in progress |
...
cannot resolve genuinely periodic flow.
...
- The crest itself does not produce significant pressure drag in this steady RANS pass. The transient run will settle whether the alternating lobes seen in the trace are real vortex shedding or a steady-solver artifact.
